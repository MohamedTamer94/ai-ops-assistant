  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-8 xs:py-12 px-3 xs:px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-md bg-white rounded-lg shadow p-6 xs:p-8">
        <h2 className="text-2xl xs:text-3xl font-bold text-gray-900 mb-6">Register</h2>
        
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="name" className="block text-xs xs:text-sm font-medium text-gray-700">
              Name
            </label>
            <input
              id="name"
